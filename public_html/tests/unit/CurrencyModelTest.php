...
// TO DO autoloading for all classes and models in currenct project 
// require "/opt/lampp/htdocs/currency_converter.com/public_html/app/Models/UserModel.model.php";
...
class CurrencyModelTest extends PHPUnit\Framework\TestCase
{
    ...
    public function  test_grab_currency_exchange_list()
    {
        ...
        $currency_model_obj = new \App\Models\CurrencyModel;
        $array_result = $currency_model_obj->grab_currency_exchange_list();
